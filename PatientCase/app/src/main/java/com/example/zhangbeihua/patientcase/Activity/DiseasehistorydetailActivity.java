 ...
 */
public class DiseasehistorydetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diseasehistorydetail);
    ...
    private DatePickerDialog.OnDateSetListener dpickerListner
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            month_x = monthOfYear;
            day_x = dayOfMonth;
            Toast.makeText(DiseasehistorydetailActivity.this, year_x + "/" + month_x, Toast.LENGTH_SHORT).show();
